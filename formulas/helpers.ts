...
// This will be replaced with a proper import when the Collection class is converted to TS
// @ts-ignore
...
export const Address = {
  /**
   * Convert column number to column name (A, B, AA, etc.)
   */
